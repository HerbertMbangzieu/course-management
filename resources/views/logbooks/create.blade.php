...
<div class="input-group px-3">
        <label for="description" class="text-lg font-bold">Details of the Session</label>
        <textarea name="description" id="description" cols="30" rows="10" class="mytextarea rounded w-full"></textarea>
    </div>
